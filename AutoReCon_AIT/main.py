...
from generator_architecture import *
...
def main():
	...
	parser.add_argument('--passing_threshold', type=float, default=0.001)
	...
	if option.network == "resnet20_cifar10":
		generator = Generator(gen_cifar10, option)
		# option.passing_threshold = 0.001
		# option.passing_threshold_first = 0.001
		# print("GI threshold changed, differ from arg")
	elif option.network == "resnet20_cifar100":
		generator = Generator(gen_cifar100, option)
		# option.passing_threshold = 0.001
		# option.passing_threshold_first = 0.001
		# print("GI threshold changed, differ from arg")
	if option.network == "resnet18":
		generator = Generator(gen_resnet18, option)
		# option.passing_threshold = 0.0001
		# option.passing_threshold_first = 0.0001
		# print("GI threshold changed, differ from arg")
	if option.network == "resnet50":
		generator = Generator(gen_resnet50, option)
		# option.passing_threshold = 0.0001
		# option.passing_threshold_first = 0.0001
		# print("GI threshold changed, differ from arg")
	if option.network == "mobilenetv2_w1":
		generator = Generator(gen_mobilev2, option)
		# option.passing_threshold = 0.0001
		# option.passing_threshold_first = 0.0001
		# print("GI threshold changed, differ from arg")
